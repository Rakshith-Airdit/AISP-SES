sap.ui.define([
    ...
    return Controller.extend("com.aisp.aispsupplierportal.controller.MultiPage", {
        onInit() {
            const oRouter = this.getOwnerComponent().getRouter();
            oRouter.getRoute("RouteMultiPage").attachPatternMatched(this.onPatternMatched, this);
        },
        ...
        onListItemPress: function (oEvent) {
            const { Ebeln, ServicePOType } = oEvent.getSource().getBindingContext().getObject();
            this.poNo = Ebeln;
            ...
            this.getView().getModel("serviceTypeModel").setProperty("/srvType", ServicePOType)
        ...
        onCreateEntrySheet: async function (oEvent) {
            ...
            if (this.srvType === "Planned") {
                ...
                if (aSelectedItems.length > 0) {
                    aSelectedItems.forEach(function (oSelectedItem) {
                        const itemValue = (Number(oSelectedItem.SERVICE_QUANTITY) || 0) *
        ...
        onSearchSESHeaderList: function (oEvent) {
            ...
            const aFilters = [
                new sap.ui.model.Filter("Ebeln", sap.ui.model.FilterOperator.EQ, sQuery),
